...
async function getArticles() {
    try {
        ...
        document.getElementById('dev-articles-count-title').innerText = `My DEV Articles (${articles.length})`;
...
async function getProjects() {
    try {
        ...
        document.getElementById('github-repo-count-title').innerText = `My GitHub Repos (${repos.length})`;
